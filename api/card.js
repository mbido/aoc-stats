export default function handler(req, res) {
  ...
  const svg = `<svg width="450" height="200" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(30, 65)">
      <use href="#star-icon" transform="translate(0, -12) scale(0.7)" fill="#F1E05A" />
      ...
      <path transform="translate(0, 35) scale(0.7)" fill="#F1E05A" d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zm.5-13H11v6l5.2 3.2.8-1.3-4.5-2.7V7z" />
      ...
      <path transform="translate(0, 60) scale(0.7)" fill="#F1E05A" d="M9 16.17l-4.17-4.17-1.42 1.41 5.59 5.59 12-12-1.41-1.41z" />
      ...
      <path transform="translate(0, 85) scale(0.7)" fill="#F1E05A" d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z" />
