export default function handler(req, res) {
  ...
  const svg = `<svg width="502" height="252" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(30, 85)">
      ...
      <text x="30" y="30" font-size="16px" fill="#81A1C1" font-family="Arial, sans-serif">Stars this year: <tspan fill="#ffd700">${currentYearStars}</tspan></text>
      ...
      <text x="30" y="60" font-size="16px" fill="#81A1C1" font-family="Arial, sans-serif">Current day: <tspan fill="#87ceeb">${currentDay}</tspan></text>
      <path transform="translate(0, 74) scale(0.8)" fill="#ffd700" d="M9 16.17l-4.17-4.17-1.42 1.41 5.59 5.59 12-12-1.41-1.41z" />
      <text x="30" y="90" font-size="16px" fill="#81A1C1" font-family="Arial, sans-serif">Completed days: <tspan fill="#87ceeb">${completedDays}</tspan></text>
      ...
      <text x="30" y="120" font-size="16px" fill="#81A1C1" font-family="Arial, sans-serif">Year: <tspan fill="#e84393">${currentYear}</tspan></text>
    </g>
    <g transform="translate(390, 130)">
      <circle r="45" fill="none" stroke="rgba(232, 67, 147, 0.2)" stroke-width="12" />
      <circle r="45" fill="none" stroke="#e84393" stroke-width="12" stroke-linecap="round" transform="rotate(-90)" stroke-dasharray="${circumference}" stroke-dashoffset="${offset}" />
