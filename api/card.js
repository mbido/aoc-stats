export default function handler(req, res) {
  ...
  const svg = `<svg width="502" height="252" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(30, 85)">
      ...
      <text x="30" font-size="16px" fill="#A9FEF6" font-family="Arial, sans-serif">Total stars: <tspan x="140" fill="#F1E05A">${totalStars}</tspan></text>
      <use href="#star-icon" transform="translate(0, 14) scale(0.8)" fill="#F1E05A" />
      <text x="30" y="30" font-size="16px" fill="#A9FEF6" font-family="Arial, sans-serif">Stars this year: <tspan x="140" y="30" fill="#F1E05A">${currentYearStars}</tspan></text>
      ...
      <text x="30" y="60" font-size="16px" fill="#A9FEF6" font-family="Arial, sans-serif">Current day: <tspan x="140" y="60" fill="#A9FEF6">${currentDay}</tspan></text>
      <path transform="translate(0, 74) scale(0.8)" fill="#F1E05A" d="M9 16.17l-4.17-4.17-1.42 1.41 5.59 5.59 12-12-1.41-1.41z" />
      <text x="30" y="90" font-size="16px" fill="#A9FEF6" font-family="Arial, sans-serif">Completed days: <tspan x="140" y="90" fill="#A9FEF6">${completedDays}</tspan></text>
      ...
      <text x="30" y="120" font-size="16px" fill="#A9FEF6" font-family="Arial, sans-serif">Year: <tspan x="140" y="120" fill="#D93B7D">${currentYear}</tspan></text>
    </g>
