export default function handler(req, res) {
  ...
  const svg = `<svg width="450" height="200" xmlns="http://www.w3.org/2000/svg">
    <style>
      ...
      .progress-circle { animation: drawCircle 1s ease-out forwards; }
      .progress-number { animation: fadeIn 0.5s ease forwards; animation-delay: 0.7s; opacity: 0; }
    </style>
    ...
    <g transform="translate(30, 65)">
      <g class="stat-row">
        <use href="#star-icon" transform="translate(0, -14) scale(0.7)" fill="#F1E05A" />
      ...
      <g class="stat-row">
        <use href="#star-icon" transform="translate(0, 12) scale(0.65)" fill="none" stroke="#F1E05A" stroke-width="1.5" />
      ...
      <g class="stat-row">
        <path transform="translate(0, 37) scale(0.7)" fill="#F1E05A" d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zm.5-13H11v6l5.2 3.2.8-1.3-4.5-2.7V7z" />
      ...
      <g class="stat-row">
        <path transform="translate(0, 62) scale(0.7)" fill="#F1E05A" d="M9 16.17l-4.17-4.17-1.42 1.41 5.59 5.59 12-12-1.41-1.41z" />
      ...
      <g class="stat-row">
        <path transform="translate(0, 87) scale(0.7)" fill="#F1E05A" d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z" />
    ...
    <g transform="translate(350, 100)">
      ...
      <circle class="progress-circle" r="40" fill="none" stroke="#D93B7D" stroke-width="6" stroke-linecap="round" transform="rotate(-90)" stroke-dasharray="${circumference}" stroke-dashoffset="${circumference}" />
      <text class="progress-number" x="0" y="10" text-anchor="middle" font-size="32px" font-weight="600" fill="#A9FEF6" font-family="'Segoe UI', Ubuntu, 'Helvetica Neue', Sans-Serif">${completedDays}</text>
    </g>
  </svg>`;
