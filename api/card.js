export default function handler(req, res) {
  ...
  const svg = `<svg width="450" height="220" xmlns="http://www.w3.org/2000/svg">
    <rect x="1" y="1" width="448" height="218" fill="#141321" rx="5" stroke="#FFFFFF" stroke-width="1"/>
    <defs>
      <path id="star-icon" d="M12 0l3.7 7.5 8.3 1.2-6 5.8 1.4 8.3-7.4-3.9-7.4 3.9 1.4-8.3-6-5.8 8.3-1.2z" />
    </defs>
    <text x="30" y="35" font-size="18px" font-weight="600" fill="#D93B7D" font-family="'Segoe UI', Ubuntu, Sans-Serif">${username}'s AoC Stats</text>
    <g transform="translate(30, 65)">
      ...
      <path transform="translate(0, 39) scale(0.8)" fill="#F1E05A" d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10 10-4.5 10-10S17.5 2 12 2zm0 18c-4.4 0-8-3.6-8-8s3.6-8 8-8 8 3.6 8 8-3.6 8-8 8zm.5-13H11v6l5.2 3.2.8-1.3-4.5-2.7V7z" />
      ...
      <path transform="translate(0, 64) scale(0.8)" fill="#F1E05A" d="M9 16.17l-4.17-4.17-1.42 1.41 5.59 5.59 12-12-1.41-1.41z" />
      ...
      <path transform="translate(0, 89) scale(0.8)" fill="#F1E05A" d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11z" />
      <text x="30" y="100" font-size="14px" font-weight="600" fill="#A9FEF6" font-family="'Segoe UI', Ubuntu, 'Helvetica Neue', Sans-Serif">Year: <tspan x="170" y="100" fill="#D93B7D">${currentYear}</tspan></text>
    </g>
